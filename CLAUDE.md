...
- **Cuando la respuesta cubre varios temas distintos, va NUMERADA.** Hallazgos, tareas,
  diferencias, pendientes, opciones: lista numerada, una linea por punto, sin parrafo
  introductorio. La prosa se reserva para cuando hay un solo tema. El usuario lo pidio
  durante semanas antes de que quedara escrito: sin numeros no puede responder punto por
  punto ni saber cuantas cosas hay.
